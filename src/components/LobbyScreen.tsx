...
export default function LobbyScreen() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 p-6 flex flex-col max-w-md mx-auto">
      <header className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          {isHost ? (
            <button
              onClick={endGame}
              className="p-2 bg-zinc-900 hover:bg-red-900/40 border border-zinc-800 hover:border-red-500/50 rounded-full text-zinc-400 hover:text-red-400 transition-colors"
              title={t("End Game")}
            >
              <LogOut size={16} />
            </button>
            ...
            <button
              onClick={leaveRoom}
              className="p-2 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-full text-zinc-400 transition-colors"
              title={t("Leave Room")}
            >
              <LogOut size={16} />
            </button>
      ...
      {!isHost && (
        <div className="mt-8 pt-4 border-t border-zinc-900 text-center text-zinc-500 text-sm">
